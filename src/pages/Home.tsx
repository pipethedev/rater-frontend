        ...
        <>
            ...
            <div className='max-w-7xl mx-auto my-32 md:my-40 bg-[#FFFCF5]'>
                <div className="mx-3">
                    ...
                    <div className="my-4">
                    <Link to="/dashboard" onClick={() => window.location.href = 'https://user.findcrest.com' } className="bg-[#3B71F7] shadow-md py-4 md:py-6 px-8 md:px-12 rounded-full font-bold text-white"> Upload your Music</Link>
